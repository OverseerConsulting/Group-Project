...
describe("User registration", function () {
    test("User passed in with all correct fields", async () => {
        whatwgFetch.fetch = await fetch('http://localhost:5000/api/users/register', {
            method: 'POST',
            headers: {
...
describe("User Login", function () {
    test("User passed in with all correct fields", async () => {
        whatwgFetch.fetch = await fetch('http://localhost:5000/api/users/login', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json"
            },
    ...
    test("User passed in without email", async () => {
        whatwgFetch.fetch = await fetch('http://localhost:5000/api/users/login', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json"
    ...
    test("User passed in without email password", async () => {
        whatwgFetch.fetch = await fetch('http://localhost:5000/api/users/login', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json"
    ...
    test("User passed in with incorrect password or email", async () => {
        whatwgFetch.fetch = await fetch('http://localhost:5000/api/users/login', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json"
